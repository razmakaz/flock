<script lang="ts">
	...
	const { t, translate, invoiceData } = page.data;
		...
		<div class="left-footer">
			...
			<div class="footer-section">
				...
				<div class="payment-details">
					...
					<p>
						<span>${translate('invoice.accountNumber')}</span> ${invoiceData.bank.accountNumber}
					</p>
					<p>
						<span>${translate('invoice.routingNumber')}</span> ${invoiceData.bank.routingNumber}
					</p>
				</div>
			</div>
